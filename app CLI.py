...
class Checkout:
    ...
    def __init__(self, cart, wish_list):
        self.cart = cart
        self.wist_list = wish_list
    ...
    def proses(self):
        ...
        try:
            subTotal_wish_list = self.wist_list.hitungSubtotal()
        except:
            subTotal_wish_list = 0

        subTotal += subTotal_wish_list
    ...
    if role == "admin":
        ...
        while True:
            ...
            if choice == '1':
                ...
                if lanjut == "y":
                    Checkout(cart, wish_cart).proses()
                input("\nTekan Enter untuk kembali...")
            elif choice == '7':
